...
# REVIEW 2026-05-12
- VFunc New... van con return interface, vi du: [user_queries.go](services/core-user/internal/infra/persistence/user_queries.go), [user_authenticator.go](services/core-user/internal/usecase/user/user_authenticator.go)
- Van con define struct va business logic trong cung 1 file voi interface, vi du [todo_queries.go](services/core-todo/internal/domain/gateway/todo_queries.go)
- TODO comment, vi du [todo.resolvers.go](services/bff-web/internal/handler/graph/todo.resolvers.go)
- 
