// Package handler contains gRPC handlers for todo service.
package handler
...
type TodoHandler struct {
	...
	todoListCreator usecase.TodoListCreator
	todoListGetter  usecase.TodoListGetter
	todoListLister  usecase.TodoListLister
	todoListUpdater usecase.TodoListUpdater
	todoListDeleter usecase.TodoListDeleter
}
